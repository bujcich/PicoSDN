...
public class TopologyResourceTest extends ResourceTest {
    ...
    private static class MockTopologyService extends TopologyServiceAdapter {
        final DefaultTopologyVertex root = new DefaultTopologyVertex(
                did("rootnode"));
        final Topology topology = new MockTopology();
        final TopologyCluster cluster1 = new DefaultTopologyCluster(
                ClusterId.clusterId(0), 2, 1, root);
        final TopologyCluster cluster2 = new DefaultTopologyCluster(
                ClusterId.clusterId(1), 4, 3, root);
        ...
        @Override
        public TopologyCluster getCluster(Topology topology,
                ClusterId clusterId) {
            return cluster1;
        }
    ...
    public void getTopologyClusters() {
        WebTarget wt = target();
        String response = wt.path("topology/clusters").request()
                .get(String.class);
        JsonObject result = Json.parse(response).asObject();
        assertThat(result, notNullValue());
    ...
    public void getCluster() {
        WebTarget wt = target();
        String response = wt.path("topology/clusters/0").request()
                .get(String.class);
        JsonObject result = Json.parse(response).asObject();
        assertThat(result, notNullValue());
    ...
    public void getClusterDevices() {
        WebTarget wt = target();
        String response = wt.path("topology/clusters/0/devices").request()
                .get(String.class);
        JsonObject result = Json.parse(response).asObject();
        assertThat(result, notNullValue());
    ...
    public void getClusterLinks() {
        WebTarget wt = target();
        String response = wt.path("topology/clusters/1/links").request()
                .get(String.class);
        JsonObject result = Json.parse(response).asObject();
        assertThat(result, notNullValue());
    ...
    public void getBroadcast() {
        WebTarget wt = target();
        String response = wt.path("topology/broadcast/dev1:1").request()
                .get(String.class);
        JsonObject result = Json.parse(response).asObject();
        assertThat(result, notNullValue());
    ...
    public void getInfrastructure() {
        WebTarget wt = target();
        String response = wt.path("topology/infrastructure/dev2:1").request()
                .get(String.class);
        JsonObject result = Json.parse(response).asObject();
        assertThat(result, notNullValue());
