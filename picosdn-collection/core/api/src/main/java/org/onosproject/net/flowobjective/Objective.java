 ...
 */
@Beta
public interface Objective extends ProvEntity {
    ...
    enum Operation {
        /**
         * Adds the objective. Can be used for any flow objective. For
         * forwarding and filtering objectives, existing objectives with
         * identical selector and priority fields (but different treatments or
         * next) will be replaced. For next objectives, if modification is
         * desired, ADD will not do anything - use ADD_TO_EXISTING.
         */
        ADD,
        ...
        /**
         * Modify an existing Next Objective. Can be used to modify group
         * buckets.
         */
        MODIFY,
         ...
         * are correctly represented by the underlying implementation of the
         * objective. Corrective action is taken if discrepancies are found
         * during verification. For example, if the next objective defines 3
         * sets of treatments, which are meant to be implemented as 3 buckets in
         * a group, but verification finds less or more buckets, then the
         * appropriate buckets are added or removed to match the objective.
         *
     ...
     *
     * @return optional; which will be empty if there is no context. Otherwise
    ...
    interface Builder {
        ...
        /**
         * Builds the objective that will be added. The context will be used to
        ...
        /**
         * Builds the objective that will be removed. The context will be used
