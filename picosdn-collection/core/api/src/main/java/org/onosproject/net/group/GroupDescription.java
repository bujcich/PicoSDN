...
/**
 * ONOS representation of group description that is used to create a group. It
 * contains immutable properties of a ONOS group construct such as "type",
 * "DeviceId", "appCookie", "appId" and "buckets"
 */
public interface GroupDescription extends ProvEntity {
    /**
