...
/**
 * Representation of a group of devices located in a common physical or logical
 * region. Optionally, devices in the region can share the same cluster nodes
 * mastership affinities.
 */
public interface Region extends Annotated, ProvEntity {
    ...
    /**
     * Returns the list of master node sets. The sets of cluster node
     * identifiers should be listed in the order of preferred mastership. Nodes
     * specified in each sets should be considered with equally priority and
     * devices in the region can be balanced between them based on other
     * criteria, e.g. load.
     *
