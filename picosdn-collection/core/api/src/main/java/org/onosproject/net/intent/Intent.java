 ...
 */
@Beta
public abstract class Intent implements ProvEntity {
     ...
     */
    protected Intent(ApplicationId appId, Key key,
            Collection<NetworkResource> resources, int priority,
    ...
    public abstract static class Builder {
        ...
        protected Builder(Intent intent) {
            this.appId(intent.appId()).key(intent.key())
     ...
     * <p>
     * When an Intent is updated, (e.g., flow is re-routed in reaction to
     * network topology change) related Intent object's {@link IntentId} may
     * change, but the key will remain unchanged.
     *
     * @return key
     */
    public Key key() {
