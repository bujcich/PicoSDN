 ...
 */
public interface Meter extends PiTranslatable, ProvEntity {
     ...
     *
     * @return a meter id
     * @deprecated in Nightingale release (version 1.13.0). Use
     *             {@link #meterCellId()} instead.
     */
    @Deprecated
    MeterId id();
    ...
    interface Builder {
         ...
         * @return this
         * @deprecated in Nightingale release (version 1.13.0). Use
         *             {@link #withCellId(MeterCellId)} instead.
         */
        @Deprecated
        ...
        /**
         * Sets this meter as applicable to burst traffic only. Defaults to
         * false.
         *
         * @return this
         */
