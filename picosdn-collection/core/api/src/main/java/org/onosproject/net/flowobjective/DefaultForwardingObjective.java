...
public final class DefaultForwardingObjective implements ForwardingObjective {
    ...
    private DefaultForwardingObjective(Builder builder) {
        ...
        this.id = Objects.hash(selector, flag, permanent, timeout, appId,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(selector, flag, permanent, timeout, appId, priority,
                nextId, treatment, op, meta);
    }
    ...
    public String toString() {
        return toStringHelper(this).add("id", id()).add("op", op())
                .add("priority", priority()).add("selector", selector())
                .add("treatment", treatment()).add("nextId", nextId())
                .add("meta", meta()).add("flag", flag()).add("appId", appId())
                .add("permanent", permanent()).add("timeout", timeout())
                .toString();
    }
    ...
    /**
     * Returns a new builder primed to produce entities patterned after the
     * supplied forwarding objective.
     *
     * @param fwd base fwd
    ...
    public static final class Builder implements ForwardingObjective.Builder {
        ...
        public ForwardingObjective add() {
            ...
            checkArgument(nextId != null || treatment != null,
                    "Must supply at " + "least a treatment and/or a nextId");
