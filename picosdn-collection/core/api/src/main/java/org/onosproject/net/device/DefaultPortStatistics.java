 ...
 */
public final class DefaultPortStatistics extends AbstractAnnotated
    ...
    private DefaultPortStatistics(DeviceId deviceId, PortNumber portNumber,
            long packetsReceived, long packetsSent, long bytesReceived,
            long bytesSent, long packetsRxDropped, long packetsTxDropped,
            long packetsRxErrors, long packetsTxErrors, long durationSec,
            long durationNano, Annotations annotations) {
        super(annotations);
    ...
    public boolean isZero() {
        return bytesReceived() == 0 && bytesSent() == 0
                && packetsReceived() == 0 && packetsRxDropped() == 0
                && packetsSent() == 0 && packetsTxDropped() == 0;
    }

    @Override
    public String toString() {
        return "device: " + deviceId + ", " + "port: " + this.portNumber + ", "
                + "pktRx: " + this.packetsReceived + ", " + "pktTx: "
                + this.packetsSent + ", " + "byteRx: " + this.bytesReceived
                + ", " + "byteTx: " + this.bytesSent + ", " + "pktRxErr: "
                + this.packetsRxErrors + ", " + "pktTxErr: "
                + this.packetsTxErrors + ", " + "pktRxDrp: "
                + this.packetsRxDropped + ", " + "pktTxDrp: "
                + this.packetsTxDropped + ", " + "annotations: "
                + annotations();
    }
    ...
    public static final class Builder {
        ...
        public DefaultPortStatistics build() {
            return new DefaultPortStatistics(deviceId, portNumber,
                    packetsReceived, packetsSent, bytesReceived, bytesSent,
                    packetsRxDropped, packetsTxDropped, packetsRxErrors,
                    packetsTxErrors, durationSec, durationNano, annotations);
        }
