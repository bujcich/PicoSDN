 ...
 */
public interface FlowRule extends PiTranslatable, ProvEntity {
    ...
    /**
     * Reason for flow parameter received from switches. Used to check reason
     * parameter in flows.
     */
    enum FlowRemoveReason {
        IDLE_TIMEOUT, HARD_TIMEOUT, DELETE, GROUP_DELETE, METER_DELETE,
        EVICTION, NO_REASON;
    ...
    /**
     * Returns the hard timeout for this flow requested by an application. This
     * parameter configure switch's flow hard timeout. In case of
     * controller-switch connection lost, this variable can be useful.
     * 
     ...
     *
     * @return an integer.
     * @deprecated in Loon release (version 1.11.0). Use {@link #table()}
     *             instead.
     */
    @Deprecated
    int tableId();
     ...
     * in the argument.
     * <p>
     * Exact match means that deviceId, priority, selector, tableId, flowId and
     * treatment are equal. Note that this differs from the notion of object
     * equality for flow rules, which does not consider the flowId or treatment
    ...
    interface Builder {
        ...
        /**
         * Assigns the application that built this flow rule to this object. The
         * short value of the appId will be used as a basis for the cookie value
         * computation. It is expected that application use this call to set
         ...
         * {@link TableId.Type#INDEX}. Default value is 0.
         * <p>
         * <em>Important:</em> This method is left here for backward
         * compatibility with applications that specifies table identifiers
         * using integers, e.g. as in OpenFlow. Currently there is no plan to
         * deprecate this method, however, new applications should favor using
         * {@link #forTable(TableId)}.
         *
        ...
        /**
         * Sets the table identifier for this flow rule. Default identifier is
         * of type {@link TableId.Type#INDEX} and value 0.
         *
        ...
        /**
         * Makes this rule temporary and timeout after the specified amount of
         * time.
         *
         ...
         *
         * Will automatically make it permanent or temporary if the timeout is 0
         * or not, respectively.
         * 
         * @param timeout an integer
         * @return this
