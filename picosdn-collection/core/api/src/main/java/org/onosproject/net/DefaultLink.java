...
public class DefaultLink extends AbstractProjectableModel implements Link {
     ...
     */
    protected DefaultLink(ProviderId providerId, ConnectPoint src,
    ...
    /**
     * Creates an infrastructure link using the supplied information. Links
     * marked as durable will remain in the inventory when a vanish message is
     * received and instead will be marked as inactive.
     *
     * @param providerId  provider identity
     * @param src         link source
     * @param dst         link destination
     ...
     * @param annotations optional key/value annotations
     */
    private DefaultLink(ProviderId providerId, ConnectPoint src,
            ConnectPoint dst, Type type, State state, boolean isExpected,
            Annotations... annotations) {
    ...
    // Note: Durability & state are purposefully omitted form equality &
    // hashCode.
    ...
    public String toString() {
        return toStringHelper(this).add("src", src).add("dst", dst)
                ...
                .add("expected", isExpected).toString();
    }
    ...
    public static class Builder {
        ...
        public DefaultLink build() {
            ...
            return new DefaultLink(providerId, src, dst, type, state,
