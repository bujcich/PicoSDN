...
public class Interface implements ProvEntity {
    ...
    public Interface(String name, ConnectPoint connectPoint,
            List<InterfaceIpAddress> ipAddresses, MacAddress macAddress,
            VlanId vlan) {
        this(name, connectPoint, ipAddresses, macAddress, vlan, null, null,
                null);
    }
     ...
     * @param macAddress   MAC address
     * @param vlan         VLAN ID
     * @param vlanUntagged untagged VLAN. Cannot be used with vlanTagged or
     *                     vlanNative.
     * @param vlanTagged   tagged VLANs. Cannot be used with vlanUntagged.
     * @param vlanNative   native vLAN. Optional. Can only be used when
     *                     vlanTagged is specified. Cannot be used with
     *                     vlanUntagged.
     */
    public Interface(String name, ConnectPoint connectPoint,
            List<InterfaceIpAddress> ipAddresses, MacAddress macAddress,
            VlanId vlan, VlanId vlanUntagged, Set<VlanId> vlanTagged,
            VlanId vlanNative) {
        ...
        this.vlanTagged = vlanTagged == null ? ImmutableSet.of()
                : ImmutableSet.copyOf(vlanTagged);
    ...
    /**
     * Retrieves the VLAN ID that is assigned to untagged packets on this tagged
     * interface.
     *
     * @return the VLAN ID
     */
    ...
    public String toString() {
        return MoreObjects.toStringHelper(getClass()).add("name", name)
                ...
                .add("ipAddresses", ipAddresses).add("macAddress", macAddress)
                .add("vlan", vlan).add("vlanUntagged", vlanUntagged)
                .add("vlanTagged", vlanTagged).add("vlanNative", vlanNative)
                .toString();
    }
