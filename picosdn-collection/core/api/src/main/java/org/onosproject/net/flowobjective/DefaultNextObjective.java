...
public final class DefaultNextObjective implements NextObjective {
    ...
    public String toString() {
        return toStringHelper(this).add("id", id()).add("type", type())
                .add("op", op()).add("priority", priority()).add("next", next())
                .add("meta", meta()).add("appId", appId())
    ...
    public static final class Builder implements NextObjective.Builder {
        ...
        private final ImmutableList.Builder<TrafficTreatment> listBuilder = ImmutableList
                .builder();
        ...
        public NextObjective add(ObjectiveContext context) {
            ...
            checkArgument(!treatments.isEmpty(),
