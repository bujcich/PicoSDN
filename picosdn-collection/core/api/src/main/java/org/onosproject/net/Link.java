...
public interface Link
        extends Annotated, Provided, Projectable, NetworkResource, ProvEntity {
    ...
    enum Type {
         ...
         * underlying segments or hops, and as such should be used to tag links
         * traversing optical paths, tunnels or intervening 'dark' switches.
         */
        INDIRECT,
        ...
        /**
         * Signifies that this link represents a logical link backed by some
         * form of a tunnel, e.g., GRE, MPLS, ODUk, OCH.
         */
        TUNNEL,

        /**
         * Signifies that this link is realized by fiber (either single channel
         * or WDM).
         */
        OPTICAL,
     ...
     * configured durable links, i.e. those that need to remain present, but
     * instead be marked as inactive.
     */
    enum State {
        /**
