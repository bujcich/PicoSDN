...
public final class DefaultMeter implements Meter, MeterEntry {
    ...
    private DefaultMeter(DeviceId deviceId, MeterCellId cellId,
            ApplicationId appId, Unit unit, boolean burst,
    ...
    public MeterId id() {
        ...
        return cellId.type() == INDEX ? (MeterId) cellId
    ...
    public String toString() {
        return toStringHelper(this).add("device", deviceId)
                .add("cellId", cellId).add("appId", appId.name())
                .add("unit", unit).add("isBurst", burst).add("state", state)
    ...
    public static final class Builder implements Meter.Builder {
        ...
        public DefaultMeter build() {
            ...
            return new DefaultMeter(deviceId, cellId, appId, unit, burst,
                    bands);
        }
