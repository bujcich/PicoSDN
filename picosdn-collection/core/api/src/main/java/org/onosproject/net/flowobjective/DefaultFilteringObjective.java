...
public final class DefaultFilteringObjective implements FilteringObjective {
    ...
    private DefaultFilteringObjective(Builder builder) {
        ...
        this.id = Objects.hash(type, key, conditions, permanent, timeout, appId,
                priority);
    }
    ...
    public String toString() {
        return toStringHelper(this).add("id", id()).add("type", type())
                .add("op", op()).add("priority", priority()).add("key", key())
                .add("conditions", conditions()).add("meta", meta())
                .add("appId", appId()).add("permanent", permanent())
    ...
    public static final class Builder implements FilteringObjective.Builder {
        private final ImmutableList.Builder<Criterion> listBuilder = ImmutableList
                .builder();
