...
public final class DefaultTableStatisticsEntry implements TableStatisticsEntry {
     ...
     */
    public DefaultTableStatisticsEntry(DeviceId deviceId, int tableId,
            long activeFlowEntries, long packetsLookedupCount,
    ...
    public String toString() {
        return "device: " + deviceId + ", " + "tableId: " + this.tableId + ", "
