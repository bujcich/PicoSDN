 ...
 */
public interface Port extends Annotated, ProvEntity {
    ...
    enum Type {
         ...
         * The signal from the client side will be formed into a ITU G.709 (OTN)
         * frame.
         */
        ODUCLT,
        ...
        /**
         * Signifies optical fiber-based WDM port (called W-port). Optical
         * Multiplexing Section (See ITU G.709).
         */
        OMS,
