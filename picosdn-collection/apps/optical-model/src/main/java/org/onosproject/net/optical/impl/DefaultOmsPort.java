...
/**
 * Implementation of OMS port (Optical Multiplexing Section). Also referred to
 * as a WDM port or W-port. See ITU G.709 "Interfaces for the Optical Transport
 * Network (OTN)"
 *
...
public class DefaultOmsPort extends ForwardingPort implements OmsPort {
     ...
     */
    public DefaultOmsPort(Port delegate, Frequency minFrequency,
            Frequency maxFrequency, Frequency grid) {
        super(delegate);
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), minFrequency(), maxFrequency(),
                grid());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            return super.toEqualsBuilder(that)
                    ...
                    .append(this.grid(), that.grid()).isEquals();
        }
        return false;
    }
    ...
    public String toString() {
        return super.toStringHelper().add("minFrequency", minFrequency())
                .add("maxFrequency", maxFrequency()).add("grid", grid())
