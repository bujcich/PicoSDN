 ...
 * port (L-port) or narrow band port. See ITU G.709 "Interfaces for the Optical
...
public class DefaultOchPort extends ForwardingPort implements OchPort {
     ...
     */
    public DefaultOchPort(Port base, OduSignalType signalType,
            boolean isTunable, OchSignal lambda) {
        super(base);
        // TODO should this class be parsing annotation to instantiate
        // signalType?
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), signalType(), isTunable(),
                lambda());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            return super.toEqualsBuilder(that)
                    ...
                    .append(this.lambda(), that.lambda()).isEquals();
        }
        return false;
    }
    ...
    public String toString() {
        return super.toStringHelper().add("signalType", signalType())
                .add("isTunable", isTunable()).add("lambda", lambda())
