 ...
 */
@Beta
public class DefaultOpticalDevice extends AbstractBehaviour
    ...
    // TODO Is there a use case, where we need to differentiate this map per
    // Device?
    private static final Map<Class<? extends Port>, PortMapper<? extends Port>> MAPPERS = ImmutableMap
            .<Class<? extends Port>, PortMapper<? extends Port>>builder()
    ...
    public Device delegate() {
        if (delegate == null) {
            ...
            DeviceService service = DefaultServiceDirectory
                    .getService(DeviceService.class);
